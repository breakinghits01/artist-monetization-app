...
echo "🔗 Via Cloudflare: https://artist-app.dynamicmonetization.com/ (PRIMARY - Unlimited bandwidth)"
echo "🔗 Via ngrok: https://caryl-exertive-treva.ngrok-free.dev/ (BACKUP)"
echo ""
