    ...
    if (downloadState?.isDownloading == true) {
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            if (downloadState.currentSongTitle != null)
                              Text(
                                downloadState.currentSongTitle!,
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          ref.read(playlistDownloadProvider.notifier).cancelPlaylistDownload(
                            widget.playlistId,
                            _songs,
                          );
                        },
          ...
          return Card(
            ...
            child: ListTile(
              ...
              subtitle: Text(
                '${_songs.length} songs available offline',
